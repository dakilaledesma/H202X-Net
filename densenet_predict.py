...
model = load_model("models/densenet201-5", custom_objects={'AdamAccumulate': AdamAccumulate}, compile=False)
...
with open('densenet201_traingen_classes', 'rb') as classes_file:
...
output = open("outputs/densenet-5.txt", 'w')
