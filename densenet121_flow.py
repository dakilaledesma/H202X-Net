...
train_gen = datagen.flow_from_dataframe(file_df, target_size=(224, 327), shuffle=True, class_mode="categorical")
...
dn_model = DenseNet121(weights=None, include_top=False, input_shape=(224, 327, 3))
